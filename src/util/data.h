...
public:
	...
	bool Int(const std::string& key, int& value) const;
	...
	bool Double(const std::string& key, double& value) const;
	...
	bool IntList(const std::string& key, std::vector<int>& list) const;
	// int list parser
	...
	bool DoubleList(const std::string& key, std::vector<double>& list) const;
	// string list parser
	// parses a comma (',') delimited list of the value and appends them to the given list
	bool StringList(const std::string& key, std::vector<std::string>& list) const;
